  ...
  return (
    <>
      ...
      <div className="accueil-corner visible">
        <img src="/assets/accueil.png" alt="" className="accueil-corner-img" />
      </div>
      <div className="bgmap-corner visible">
        <img src="/assets/bgmap.png" alt="" className="bgmap-corner-img" />
      </div>
      <div className="bgprofil-corner visible">
        <img src="/assets/bgprofil.png" alt="" className="bgprofil-frame-img" />
      </div>
